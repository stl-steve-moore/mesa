...
// $Id: MStationName.hpp,v 1.3 2006/06/29 16:08:31 bhasselfeld Exp $ $Author: bhasselfeld $ $Revision: 1.3 $ $Date: 2006/06/29 16:08:31 $ $State: Exp $
//
// ====================
//  = FILENAME
//	MStationName.hpp
...
#ifndef MStationNameISIN
#define MStationNameISIN
...
class MStationName;
typedef vector < MStationName > MStationNameVector;

class MStationName : public MDomainObject
// = TITLE
...
public:
  ...
  MStationName();
  ///< Default constructor
  MStationName(const MStationName& cpy);
  virtual ~MStationName();
  virtual void printOn(ostream& s) const;
  /**<\brief This method is used in conjunction with the streaming operator <<
  	     to print the current state of MStationName */
  ...
  MStationName( MString& s, const MString& key);
...
inline ostream& operator<< (ostream& s, const MStationName& c) {
	  c.printOn(s);
	  return s;
};

inline istream& operator >> (istream& s, MStationName& c) {
  c.streamIn(s);
  return s;
}
