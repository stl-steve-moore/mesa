...
// $Id: MPerfWorkitem.hpp,v 1.2 2006/06/29 16:08:31 bhasselfeld Exp $ $Author: bhasselfeld $ $Revision: 1.2 $ $Date: 2006/06/29 16:08:31 $ $State: Exp $
//
// ====================
//  = FILENAME
//	MPerfWorkitem.hpp
...
#ifndef MPerfWorkitemISIN
#define MPerfWorkitemISIN
...
class MPerfWorkitem;
typedef vector < MPerfWorkitem > MPerfWorkitemVector;

class MPerfWorkitem : public MDomainObject
// = TITLE
///	a domain object which corresponds to Performed Workitem code sequence items.
//
// = DESCRIPTION
...
public:
  ...
  MPerfWorkitem();
  ///< Default constructor
  MPerfWorkitem(const MPerfWorkitem& cpy);
  virtual ~MPerfWorkitem();
  virtual void printOn(ostream& s) const;
  /**<\brief This method is used in conjunction with the streaming operator <<
  	     to print the current state of MPerfWorkitem */
  ...
  MPerfWorkitem( MString& s, const MString& key);
...
inline ostream& operator<< (ostream& s, const MPerfWorkitem& c) {
	  c.printOn(s);
	  return s;
};

inline istream& operator >> (istream& s, MPerfWorkitem& c) {
  c.streamIn(s);
  return s;
}
