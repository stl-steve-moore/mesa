<?php
    ...
    $title = "<a href=\"index.php\">MESA RIS Mall</a>:: <a href=\"$actorLink\">$printSource</a>:: Send Admit/Registration Message";
    $title_no_link = "MESA RIS Mall:: ". $printSource . " :: Send Admit/Registration Message";
