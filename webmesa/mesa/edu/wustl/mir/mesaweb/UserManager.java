...
public class UserManager extends HttpServlet {
	...
	out.println (html.printHeader ("Manage User Information"));
	...
	out.println ("<UL>");
	out.println ("<LI><A HREF=/servlet/UserManager?action=viewUsers> Users </A><br>");
	out.println ("<LI><A HREF=/servlet/UserManager?action=viewLastRequest> Last Request </A><br>");
	out.println ("</UL>");
	...
	out.println ("<FORM ACTION='/servlet/UserManager'>");
