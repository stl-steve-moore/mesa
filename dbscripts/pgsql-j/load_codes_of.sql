...
-- Entries for Japanese implementations
insert into schedule(uniserid, spsindex, spsdes) values
 ('GX.01.00^XXXX^JJ1017', 2000, 'XXXX');
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('2000', 'GX.01.00_PC1', 'GX.01.00 Protocol Code Item 1', 'DSS_MESA');
insert into schedule(uniserid, spsindex, spsdes) values
 ('GX.01.01^GX 01 01^JJ1017', 2005, 'GX 01 01');
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('2005', 'GX.01.01_PC1', 'GX.01.01 Protocol Code Item 1', 'DSS_MESA');

insert into schedule(uniserid, spsindex, spsdes) values
 ('XA.02.00^XA-02-00^JJ1017', 2010, 'XA-02-00');
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('2010', 'XA.02.00_PC1', 'XA.02.00 Protocol Code Item 1', 'DSS_MESA');
insert into schedule(uniserid, spsindex, spsdes) values
 ('XA.02.00^XA-02-00^JJ1017', 2011, 'XA-02-00');
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('2011', 'XA.02.00_PC2', 'XA.02.00 Protocol Code Item 2', 'DSS_MESA');

insert into schedule(uniserid, spsindex, spsdes) values
 ('NM.02.00^VVVV^JJ1017', 2020, 'VVVV');
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('2020', 'NM.02.00_PC1', 'NM.02.00 Protocol Code Item 1', 'DSS_MESA');

insert into schedule(uniserid, spsindex, spsdes) values
 ('MR.01.00^MR^JJ1017', 2030, 'MR');
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('2030', 'MR.01.00_PC1', 'MR.01.00 Protocol Code Item 1', 'DSS_MESA');
