...
print "isql -E -S $MESA_SQL_SERVER_NAME -U$MESA_SQL_LOGIN -P$MESA_SQL_PASSWORD -d ordfil < load_id_of.sql \n";
print `isql -E -S $MESA_SQL_SERVER_NAME -U$MESA_SQL_LOGIN -P$MESA_SQL_PASSWORD -d ordfil < load_id_of.sql`;

print "isql -E -S $MESA_SQL_SERVER_NAME -U$MESA_SQL_LOGIN -P$MESA_SQL_PASSWORD -d ordfil < load_codes_of.sql \n";
print `isql -E -S $MESA_SQL_SERVER_NAME -U$MESA_SQL_LOGIN -P$MESA_SQL_PASSWORD -d ordfil < load_codes_of.sql`;
