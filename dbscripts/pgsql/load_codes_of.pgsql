...
-- HIMSS 2004 demonstration
insert into schedule(uniserid, spsindex, spsdes) values
 ('241540006^CT of lungs^SNOMED', 3010, 'CT lungs');
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('3010', '18-5002', 'Lung CT', 'HL7IHE');

insert into schedule(uniserid, spsindex, spsdes) values
 ('67632007^Diagnostic radiography of chest, PA^SNOMED', 3020, 'Chest, PA');
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('3020', '18-5022', 'Chest PA', 'HL7IHE');

-- IHE Cardiology starting fall 2004
-- These are for Cardiac Cath cases
insert into schedule(uniserid, spsindex, spsdes) values
 ('CATH.001^Cardiac Cath Consultation^ERL_MESA', 40011, 'Left Heart Cath');
insert into schedule(uniserid, spsindex, spsdes) values
...
insert into schedule(uniserid, spsindex, spsdes) values
 ('ECHO.001^TTE^ERL_MESA', 40021, 'TTE');

insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('40021', 'XX-20021', 'TTE', 'DSS_MESA');

insert into schedule(uniserid, spsindex, spsdes) values
 ('ECHO.002^STRESS ECHO^ERL_MESA', 40031, 'Stress Echo');

insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('40031', 'XX-20031', 'Stress Echo', 'DSS_MESA');
...
insert into actionitem(spsindex, codval, codmea, codschdes) values
 ('5009', '9', '45 Deg Center On Disk & Macula - OD', '99AAODemo');
