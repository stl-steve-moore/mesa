...
// $Id: MLQuery.hpp,v 1.2 2001/11/13 21:07:25 smm Exp $ $Author: smm $ $Revision: 1.2 $ $Date: 2001/11/13 21:07:25 $ $State: Exp $
//
// ====================
//  = LIBRARY
//	xxx
...
public:
  ...
  int queryAllWorkOrders();
  int queryNewWorkOrders();
  int workOrderCount();
  MWorkOrder getWorkOrder(int index);

  // = Class specific methods.
  int selectCallback(const MWorkOrder& workOrder);
private:
  MDBImageManager& mImageManager;
  MWorkOrderVector mWorkOrderVector;
};
