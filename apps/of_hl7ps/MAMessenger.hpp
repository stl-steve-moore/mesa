...
// $Id: MAMessenger.hpp,v 1.5 2000/05/09 18:58:30 smm Exp $ $Author: smm $ $Revision: 1.5 $ $Date: 2000/05/09 18:58:30 $ $State: Exp $
// ====================
//  = LIBRARY
//	of_hl7ps Analysis mode
//
//  = FILENAME
//	MAMessenger.hpp
//
...
public:
  ...
  MAMessenger (MHL7Factory& factory, MDBOrderFiller& mDatabase, MString LogDir);
  
  MAMessenger* clone();

  int acceptADT(MHL7Msg& message, const MString& event);
  int acceptORM(MHL7Msg& message, const MString& event);
  int acceptORR(MHL7Msg& message, const MString& event);
