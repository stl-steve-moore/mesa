...
#if 0
MLEvalSimple1::MLEvalSimple1()
{
}
#endif

MLEvalSimple1::MLEvalSimple1(const MLEvalSimple1& cpy) :
  MLMPPSEvaluator(cpy)
{
}
...
void
MLEvalSimple1::printOn(ostream& s) const
{
  s << "MLEvalSimple1";
}

void
MLEvalSimple1::streamIn(istream& s)
{
  //s >> this->member;
}
...
MLEvalSimple1::MLEvalSimple1(MDICOMWrapper& testData,
...
int
MLEvalSimple1::run(const MString& dataSource, const MString& operation)
{
