...
// $Id: MLDispatchReportMgrJapanese.hpp,v 1.3 2006/06/30 13:47:41 bhasselfeld Exp $ $Author: bhasselfeld $ $Revision: 1.3 $ $Date: 2006/06/30 13:47:41 $ $State: Exp $
// ====================
//  = FILENAME
//	MLDispatchReportMgrJapanese.hpp
//
//  = AUTHOR
//	PD
//
...
#ifndef MLDispatchReportMgrJapaneseISIN
#define MLDispatchReportMgrJapaneseISIN
...
class MLDispatchReportMgrJapanese : public MHL7Dispatcher
{
public:
  //MLDispatchReportMgrJapanese();
  // Default constructor
  MLDispatchReportMgrJapanese(const MLDispatchReportMgrJapanese& cpy);
  ~MLDispatchReportMgrJapanese();
  virtual void printOn(ostream& s) const;
  // This method is used in conjunction with the streaming operator <<
  // to print the current state of MLDispatchReportMgrJapanese

  virtual void streamIn(istream& s);

  // = Class specific methods.

  MLDispatchReportMgrJapanese(MHL7Factory& factory, MDBImageManagerJapanese* database,
...
inline istream& operator >> (istream& s, MLDispatchReportMgrJapanese& c) {
  c.streamIn(s);
  return s;
}
