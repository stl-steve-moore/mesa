...
// $Id: MLDispatchOrderPlacerJapanese.hpp,v 1.3 2006/06/30 13:47:40 bhasselfeld Exp $ $Author: bhasselfeld $ $Revision: 1.3 $ $Date: 2006/06/30 13:47:40 $ $State: Exp $
// ====================
//  = LIBRARY
//
//  = FILENAME
//	MLDispatchOrderPlacerJapanese.hpp 
//
//  = AUTHOR
//	Steve Moore
//
...
#ifndef MLDispatchOrderPlacerJapaneseISIN
#define MLDispatchOrderPlacerJapaneseISIN
...
class MLDispatchOrderPlacerJapanese : public MHL7Dispatcher
{
public:
  //MLDispatchOrderPlacerJapanese();
  // Default constructor
  MLDispatchOrderPlacerJapanese(const MLDispatchOrderPlacerJapanese& cpy);
  virtual ~MLDispatchOrderPlacerJapanese();
  virtual void printOn(ostream& s) const;
  // This method is used in conjunction with the streaming operator <<
  // to print the current state of MLDispatchOrderPlacerJapanese

  virtual void streamIn(istream& s);

  // = Class specific methods.

  MLDispatchOrderPlacerJapanese(MHL7Factory& factory, MDBOrderPlacerJapanese* database,
...
protected:
  ...
  MDBOrderPlacerJapanese* mDatabase;
...
inline istream& operator >> (istream& s, MLDispatchOrderPlacerJapanese& c) {
  c.streamIn(s);
  return s;
}
