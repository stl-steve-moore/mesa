...
MLDispatchReportMgr::MLDispatchReportMgr(const MLDispatchReportMgr& cpy) :
...
MLDispatchReportMgr::~MLDispatchReportMgr ()
{
}

void
MLDispatchReportMgr::printOn(ostream& s) const
{
  s << "MLDispatchReportMgr" << endl;
}

void
MLDispatchReportMgr::streamIn(istream& s)
{
  //s >> this->member;
}
...
MLDispatchReportMgr::MLDispatchReportMgr(MHL7Factory& factory, MDBImageManager* database,
...
void
MLDispatchReportMgr::logHL7Stream(const char* txt, int len)
{
  if (mAnalysisMode) {
    ...
    sprintf(logFile, "%s/%d.hl7", storageDir, ++gMsgNumber);
    {
      ...
      logClient.log(MLogClient::MLOG_VERBOSE,
                    "",
                    "MLDispatchReportMgr::logHL7Stream", __LINE__, x);
    }
...
// virtual
int
MLDispatchReportMgr::acceptADT(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"",
		"MLDispatchReportMgr::acceptADT",
		__LINE__,
...
// virtual
int
MLDispatchReportMgr::acceptORM(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"",
		"MLDispatchReportMgr::acceptORM",
		__LINE__,
...
//virtual
int
MLDispatchReportMgr::acceptXXX(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"",
		"MLDispatchReportMgr::acceptXXX",
		__LINE__,
...
void
MLDispatchReportMgr::processInfo(const MString& event, const MPatient& patient,
			 const MVisit& visit)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_VERBOSE,
		"",
		"MLDispatchReportMgr::processInfo",
		__LINE__,
...
void
MLDispatchReportMgr::clearExistingMessages()
{
  MFileOperations f;
  ...
  logClient.log(MLogClient::MLOG_VERBOSE,
		"",
		"MLDispatchReportMgr::clearMessages", __LINE__, txt);
