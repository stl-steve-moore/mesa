...
MLDispatchOrderPlacer::MLDispatchOrderPlacer(const MLDispatchOrderPlacer& cpy) :
...
MLDispatchOrderPlacer::~MLDispatchOrderPlacer ()
{
}

void
MLDispatchOrderPlacer::printOn(ostream& s) const
{
  s << "MLDispatchOrderPlacer" << endl;
}

void
MLDispatchOrderPlacer::streamIn(istream& s)
{
  //s >> this->member;
}
...
MLDispatchOrderPlacer::MLDispatchOrderPlacer(MHL7Factory& factory, MDBOrderPlacer* database,
...
// virtual
int
MLDispatchOrderPlacer::acceptADT(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"peer",
		"MLDispatchOrderPlacer::acceptADT",
		__LINE__,
...
// virtual
int
MLDispatchOrderPlacer::acceptORM(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"peer",
		"MLDispatchOrderPlacer::acceptORM",
		__LINE__,
...
// virtual
int
MLDispatchOrderPlacer::acceptORR(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"peer",
		"MLDispatchOrderPlacer::acceptORR",
		__LINE__,
...
// virtual
int
MLDispatchOrderPlacer::acceptXXX(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"peer",
		"MLDispatchOrderPlacer::acceptXXX",
		__LINE__,
...
// virtual
int
MLDispatchOrderPlacer::acceptORU(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"peer",
		"MLDispatchOrderPlacer::acceptORU",
		__LINE__,
...
void
MLDispatchOrderPlacer::logHL7Stream(const char* txt, int len)
{
  if (mAnalysisMode) {
    ...
    sprintf(storageFile, "%s/%d.hl7", storageDir, ++gMsgNumber);
    {
      ...
      logClient.log(MLogClient::MLOG_VERBOSE,
		    "peer",
		    "MLDispatchOrderPlacer::logHL7Stream", __LINE__, x);
    }
...
void
MLDispatchOrderPlacer::processInfo(const MString& event, const MPatient& patient, const MVisit& visit)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_VERBOSE,
		"peer",
		"MLDispatchOrderPlacer::processInfo",
		__LINE__,
...
void
MLDispatchOrderPlacer::processInfo(MHL7Msg& message, const MString& event,
...
void
MLDispatchOrderPlacer::sendORR(MHL7Msg& ormMsg, const MString& orderControl,
...
void
MLDispatchOrderPlacer::orderError(const MString& event, const MString& orderControl)
{
...
void
MLDispatchOrderPlacer::processError(const MString& msgType, const MString& event, const MString& additionalInfo)
{
  ...
  logClient.log(MLogClient::MLOG_ERROR,
		"peer",
		"MLDispatchOrderPlacer::processError",
		__LINE__,
		error);
}

MString
MLDispatchOrderPlacer::getNewPlacerOrderNumber()
{
...
void
MLDispatchOrderPlacer::clearExistingMessages()
{
  MFileOperations f;
  ...
  logClient.log(MLogClient::MLOG_VERBOSE,
		"peer",
		"MLDispatchOrderPlacer::clearMessages", __LINE__, txt);
