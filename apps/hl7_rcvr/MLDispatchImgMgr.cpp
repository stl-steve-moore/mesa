...
MLDispatchImgMgr::MLDispatchImgMgr(const MLDispatchImgMgr& cpy) :
...
MLDispatchImgMgr::~MLDispatchImgMgr ()
{
}

void
MLDispatchImgMgr::printOn(ostream& s) const
{
  s << "MLDispatchImgMgr" << endl;
}

void
MLDispatchImgMgr::streamIn(istream& s)
{
  //s >> this->member;
}
...
MLDispatchImgMgr::MLDispatchImgMgr(MHL7Factory& factory, MDBImageManager* database,
...
void
MLDispatchImgMgr::logHL7Stream(const char* txt, int len)
{
  if (mAnalysisMode) {
    ...
    sprintf(logFile, "%s/%d.hl7", storageDir, ++gMsgNumber);
    {
      ...
      logClient.log(MLogClient::MLOG_VERBOSE,
                    "",
                    "MLDispatchImgMgr::logHL7Stream", __LINE__, x);
    }
...
// virtual
int
MLDispatchImgMgr::acceptADT(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"",
		"MLDispatchImgMgr::acceptADT",
		__LINE__,
...
// virtual
int
MLDispatchImgMgr::acceptORM(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"",
		"MLDispatchImgMgr::acceptORM",
		__LINE__,
...
//virtual
int
MLDispatchImgMgr::acceptXXX(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"",
		"MLDispatchImgMgr::acceptXXX",
		__LINE__,
...
void
MLDispatchImgMgr::processInfo(const MString& event, const MPatient& patient,
			 const MVisit& visit)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_VERBOSE,
		"",
		"MLDispatchImgMgr::processInfo",
		__LINE__,
...
void
MLDispatchImgMgr::clearExistingMessages()
{
  MFileOperations f;
  ...
  logClient.log(MLogClient::MLOG_VERBOSE,
		"",
		"MLDispatchImgMgr::clearMessages", __LINE__, txt);
