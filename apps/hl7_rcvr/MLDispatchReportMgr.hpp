...
// $Id: MLDispatchReportMgr.hpp,v 1.3 2006/06/30 13:47:40 bhasselfeld Exp $ $Author: bhasselfeld $ $Revision: 1.3 $ $Date: 2006/06/30 13:47:40 $ $State: Exp $
// ====================
//  = FILENAME
//	MLDispatchReportMgr.hpp
//
//  = AUTHOR
//	PD
//
...
#ifndef MLDispatchReportMgrISIN
#define MLDispatchReportMgrISIN
...
class MLDispatchReportMgr : public MHL7Dispatcher
{
public:
  //MLDispatchReportMgr();
  // Default constructor
  MLDispatchReportMgr(const MLDispatchReportMgr& cpy);
  ~MLDispatchReportMgr();
  virtual void printOn(ostream& s) const;
  // This method is used in conjunction with the streaming operator <<
  // to print the current state of MLDispatchReportMgr

  virtual void streamIn(istream& s);

  // = Class specific methods.

  MLDispatchReportMgr(MHL7Factory& factory, MDBImageManager* database,
...
inline istream& operator >> (istream& s, MLDispatchReportMgr& c) {
  c.streamIn(s);
  return s;
}
