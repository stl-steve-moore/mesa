...
#if 0
MLDispatchOrderFillerJapanese::MLDispatchOrderFillerJapanese()
{
}
#endif

MLDispatchOrderFillerJapanese::MLDispatchOrderFillerJapanese(const MLDispatchOrderFillerJapanese& cpy) :
...
void
MLDispatchOrderFillerJapanese::printOn(ostream& s) const
{
  s << "MLDispatchOrderFillerJapanese" << endl;
}

void
MLDispatchOrderFillerJapanese::streamIn(istream& s)
{
  //s >> this->member;
}
...
MLDispatchOrderFillerJapanese::MLDispatchOrderFillerJapanese(MHL7Factory& factory, MDBOrderFillerJapanese* database,
...
//virtual
int
MLDispatchOrderFillerJapanese::acceptXXX(MHL7Msg& message, const MString& event)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_CONVERSATION,
		"peer",
		"MLDispatchOrderFillerJapanese::acceptXXX",
		__LINE__,
...
void
MLDispatchOrderFillerJapanese::processInfo(const MString& event, const MPatient& patient,
			 const MVisit& visit)
{
  MLogClient logClient;
  logClient.log(MLogClient::MLOG_VERBOSE,
		"peer",
		"MLDispatchOrderFillerJapanese::processInfo",
		__LINE__,
...
void
MLDispatchOrderFillerJapanese::processInfo(const MString& event, const MString& orderControl,
...
void
MLDispatchOrderFillerJapanese::processError(const MString& msgType, const MString& event, const MString& additionalInfo)
{
  ...
  logClient.log(MLogClient::MLOG_VERBOSE,
		"",
		"MLDispatchOrderFillerJapanese::processError",
		__LINE__,
		error);
}

void
MLDispatchOrderFillerJapanese::clearExistingMessages()
{
  MFileOperations f;
  ...
  logClient.log(MLogClient::MLOG_VERBOSE,
		"peer",
		"MLDispatchOrderFillerJapanese::clearMessages", __LINE__, txt);
