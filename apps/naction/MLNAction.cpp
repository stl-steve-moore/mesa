...
MLNAction::MLNAction(const MLNAction& cpy)
{
}
...
void
MLNAction::printOn(ostream& s) const
{
  s << "MLNAction";
}

void
MLNAction::streamIn(istream& s)
{
  //s >> this->member;
}
...
// virtual
CONDITION
MLNAction::handleNActionResponse(DUL_PRESENTATIONCONTEXT* ctx,
