...
// $Id: MLStorageCommitment.hpp,v 1.4 2000/05/09 03:31:50 smm Exp $ $Author: smm $ $Revision: 1.4 $ $Date: 2000/05/09 03:31:50 $ $State: Exp $
//
// ====================
//  = LIBRARY
//	xxx
...
public:
  ...
  MLStorageCommitment(MDBImageManager& manager, const MString& logDir);
