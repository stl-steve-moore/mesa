...
static char rcsid[] = "$Id: LNMFrameStatic.cpp,v 1.3 2004/09/21 15:30:16 ssurul01 Exp $";

LNMFrameStatic::LNMFrameStatic ()
{
}

LNMFrameStatic::~LNMFrameStatic (void)
{
}

LNMFrameStatic::LNMFrameStatic (const LNMFrameStatic& cpy)
{
}

void
LNMFrameStatic::printOn(ostream& s) const
{
  s << "LNMFrameStatic";
}

void
LNMFrameStatic::streamIn(istream& s)
{
}
...
int
LNMFrameStatic::extract(ofstream& f, MDICOMWrapper& w, MStringMap& m, ofstream& o)
{
  U32 frameSize = 0;
  U16 frameCount = 0;
