...
static char rcsid[] = "$Id: LNMFrameReconTomo.cpp,v 1.1 2004/09/27 20:53:06 ssurul01 Exp $";

LNMFrameReconTomo::LNMFrameReconTomo ()
{
}

LNMFrameReconTomo::~LNMFrameReconTomo (void)
{
}

LNMFrameReconTomo::LNMFrameReconTomo (const LNMFrameReconTomo& cpy)
{
}

void
LNMFrameReconTomo::printOn(ostream& s) const
{
  s << "LNMFrameReconTomo";
}

void
LNMFrameReconTomo::streamIn(istream& s)
{
}
...
int
LNMFrameReconTomo::extract(ofstream& f, MDICOMWrapper& w, MStringMap& m, ofstream& o)
{
  U32 frameSize = 0;
  U16 frameCount = 0;
