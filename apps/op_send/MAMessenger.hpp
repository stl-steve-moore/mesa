...
// $Id: MAMessenger.hpp,v 1.3 2000/05/09 19:02:47 smm Exp $ $Author: smm $ $Revision: 1.3 $ $Date: 2000/05/09 19:02:47 $ $State: Exp $
// ====================
//  = LIBRARY
//	op_hl7ps Analysis mode
//
//  = FILENAME
//	MAMessenger.hpp
//
...
public:
  ...
  MAMessenger (MHL7Factory& factory, MDBOrderPlacer& mDatabase, MString LogDir);
  //MAMessenger(MHL7Factory& factory, MDBOrderPlacer& database);
...
private:
  ...
  //int mMsgNumber;
  // The number of messages recieved.
  MString mLogDir;
