...
// $Id: MLQuery.hpp,v 1.1 2000/08/10 03:58:38 smm Exp $ $Author: smm $ $Revision: 1.1 $ $Date: 2000/08/10 03:58:38 $ $State: Exp $
//
// ====================
//  = FILENAME
//	MLQuery.hpp
...
class MDICOMWrapper;
typedef vector < MDICOMWrapper* > WRAPPERVector;
...
public:
  ...
  WRAPPERVector wrapperVector();
  void clearVector();

private:
  int mMsgnum;
  char* mPath;
  WRAPPERVector mWrapperVector;
};
