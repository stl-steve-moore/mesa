...
// $Id: MLGPPPS.hpp,v 1.1 2005/03/15 14:59:18 smm Exp $ $Author: smm $ $Revision: 1.1 $ $Date: 2005/03/15 14:59:18 $ $State: Exp $
//
// ====================
//  = LIBRARY
//	xxx
...
public:
  ...
  MLGPPPS(MDBOrderFillerBase& OrderFiller, const MString& logDir);
