...
// $Id: MLQuery.hpp,v 1.11 2008/03/19 20:38:50 smm Exp $ $Author: smm $ $Revision: 1.11 $ $Date: 2008/03/19 20:38:50 $ $State: Exp $
//
// ====================
//  = LIBRARY
//	xxx
...
class MLQuery : public MSOPHandler, public MDBOFClient
// = TITLE
...
public:
  ...
  MLQuery(MDBOrderFillerBase& ordfil, MString logDir);
  ...
  MMWLObjectsVector retMMWLObjects();

  int objectVectorSize() const;
  MMWLObjects& getMMWLObjects(int index);

private:
  MDBOrderFillerBase& mOrderFiller;
  MMWLObjectsVector mObjectsVector;
  MString mLogDir;
