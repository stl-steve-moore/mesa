...
// $Id: MLMPPS.hpp,v 1.6 2003/12/14 19:54:22 smm Exp $ $Author: smm $ $Revision: 1.6 $ $Date: 2003/12/14 19:54:22 $ $State: Exp $
//
// ====================
//  = LIBRARY
//	xxx
...
public:
  ...
  MLMPPS(MDBOrderFillerBase& OrderFiller, const MString& logDir);
