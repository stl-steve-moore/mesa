...
#if 0
MAMessenger::MAMessenger(MHL7Factory& factory, MDBImageManager& database) :
...
MAMessenger::MAMessenger(MHL7Factory& factory, MDBImageManager& database, MString LogDir) :
