...
// $Id: MLStorageCommitment.hpp,v 1.5 2001/04/26 22:21:58 smm Exp $ $Author: smm $ $Revision: 1.5 $ $Date: 2001/04/26 22:21:58 $ $State: Exp $
//
// ====================
//  = FILENAME
...
public:
  ...
  MLStorageCommitment(MDBImageManager& manager,
