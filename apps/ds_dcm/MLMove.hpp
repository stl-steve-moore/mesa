...
// $Id: MLMove.hpp,v 1.4 2002/08/04 16:00:08 smm Exp $ $Author: smm $ $Revision: 1.4 $ $Date: 2002/08/04 16:00:08 $ $State: Exp $
//
// ====================
//  = LIBRARY
//	xxx
...
public:
  ...
  MLMove(MDBImageManager* manager, int storeCFindQueries,
...
private:
  ...
  U16 mCompletedSubOperations;
  U16 mFailedSubOperations;
  U16 mWarningSubOperations;
  int mStoreCMoveQueries;
  MString mStorageDirectory;
};
