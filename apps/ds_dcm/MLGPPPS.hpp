...
// $Id: MLGPPPS.hpp,v 1.1 2002/07/17 19:47:21 drm Exp $ $Author: drm $ $Revision: 1.1 $ $Date: 2002/07/17 19:47:21 $ $State: Exp $
//
// ====================
//  = LIBRARY
//	xxx
...
public:
  ...
  MLGPPPS(MDBImageManager* manager, const MString& logDir,
