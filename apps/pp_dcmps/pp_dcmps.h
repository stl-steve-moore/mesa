...
** Last Update:		$Author: drm $, $Date: 2002/04/16 19:10:25 $
** Source File:		$RCSfile: pp_dcmps.h,v $
** Revision:		$Revision: 1.1 $
** Status:		$State: Exp $
*/


#ifndef POST_PROC_IS_IN
#define POST_PROC_IS_IN 1

#define	POST_PROC_AE_TITLE	"DCM_POSTPMGR"
