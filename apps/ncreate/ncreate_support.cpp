...
static char rcsid[] = "$Revision: 1.1 $ $RCSfile: ncreate_support.cpp,v $";
...
CLASS_MAP m1[] = {
  { DICOM_SOPCLASSMPPS, "mpps" },
  { DICOM_SOPCLASSMPPS, DICOM_SOPCLASSMPPS},
  { DICOM_SOPCLASSMPPS, "3.1.2.3.3" },
  { DICOM_SOPGPPPS, "gppps" },
