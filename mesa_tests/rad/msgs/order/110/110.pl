...
# Generate HL7 Order messages for Case 110
...
create_text_file_2_var_files("110.106.o01.txt", "../templates/o01.tpl",
	"../../adt/110/gold.var", "110.106.o01.var");
create_hl7("110.106.o01");
