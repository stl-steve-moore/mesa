...
# Generate HL7 Order messages for Case 142x  (1421, 1422)
...
create_text_file_2_var_files("142x.106.o01.txt", "../templates/o01.tpl",
	"../../adt/142x/delaware.var", "142x.106.o01.var");
create_hl7("142x.106.o01");
