...
# Generate HL7 Order messages for Case 1411
...
create_text_file_2_var_files("1411.106.o01.txt", "../templates/o01.tpl",
	"../../adt/1411/connecticut.var", "1411.106.o01.var");
create_hl7("1411.106.o01");
