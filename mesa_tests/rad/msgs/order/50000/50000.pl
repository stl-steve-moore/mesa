...
if (scalar(@ARGV) == 0) {
  copy("50000.130.o01.var", "50000.130.o01.xxx");
} else {
# .xxx files provided in an external step
}

create_text_file_2_var_files("50000.130.o01.txt", "../templates/o01.tpl",
	"../../adt/50000/baltimore.txt", "50000.130.o01.xxx");

create_hl7("50000.130.o01");
