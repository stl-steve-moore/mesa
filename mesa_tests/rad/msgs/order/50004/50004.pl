...
# Generate HL7 Order messages for Case 50004
...
if (scalar(@ARGV) == 0) {
  copy("50004.130.o01.var", "50004.130.o01.xxx");
} else {
# .xxx files provided in an external step
}

create_text_file_2_var_files("50004.130.o01.txt", "../templates/o01.tpl",
	"../../adt/50004/york.txt", "50004.130.o01.xxx");

create_hl7("50004.130.o01");
