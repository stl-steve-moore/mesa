...
# Generate HL7 Order messages for Case 111
...
create_text_file_2_var_files("111.106.o01.txt", "../templates/o01.tpl",
	"../../adt/111/peach.var", "111.106.o01.var");
create_hl7("111.106.o01");
