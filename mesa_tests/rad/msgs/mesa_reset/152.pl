...
# This script updates the HL7 messages for test 152
...
sub process_periwinkle {
  ...
  # ADT messages for 152.102, 152.103
  copy ("adt/152/periwinkle.var", "adt/152/periwinkle.txt") or die
	"Could not copy adt/152/periwinkle.var to adt/152/periwinkle.txt\n";
  open PERIWINKLE, ">>adt/152/periwinkle.txt" or die
	"Could not open adt/152/periwinkle.txt for output\n";
  $x = "\$PERIWINKLE_NAME\$";
  ...
  # Order message, 152.104
  copy ("order/152/152.104.o01.var", "order/152/152.104.o01.xxx");
  open PERIWINKLE , ">>order/152/152.104.o01.xxx" or die
	"Could not open order/152/152.104.o01.xxx for output\n";
  $x = "\$PLACER_ORDER_NUMBER\$";
  print PERIWINKLE "\$PLACER_ORDER_NUMBER\$ = $varnames{$x}\n";
  close PERIWINKLE;

  # Appoint message, 152.106
  copy ("appoint/152/152.106.s12.var", "appoint/152/152.106.s12.xxx");
  open PERIWINKLE , ">>appoint/152/152.106.s12.xxx" or die
	"Could not open appoint/152/152.106.s12.xxx for output\n";
