...
# This script updates the HL7 messages for test 151
...
sub process_periwinkle {
  ...
  # ADT messages for 151.102, 151.103
  copy ("adt/151/periwinkle.var", "adt/151/periwinkle.txt") or die
	"Could not copy adt/151/periwinkle.var to adt/151/periwinkle.txt\n";
  open PERIWINKLE, ">>adt/151/periwinkle.txt" or die
	"Could not open adt/151/periwinkle.txt for output\n";
  $x = "\$PERIWINKLE_NAME\$";
  ...
  # Order message, 151.104
  copy ("order/151/151.104.o01.var", "order/151/151.104.o01.xxx");
  open PERIWINKLE , ">>order/151/151.104.o01.xxx" or die
	"Could not open order/151/151.104.o01.xxx for output\n";
  $x = "\$PLACER_ORDER_NUMBER\$";
  print PERIWINKLE "\$PLACER_ORDER_NUMBER\$ = $varnames{$x}\n";
  close PERIWINKLE;

  # Appoint message, 151.106
  copy ("appoint/151/151.106.s12.var", "appoint/151/151.106.s12.xxx");
  open PERIWINKLE , ">>appoint/151/151.106.s12.xxx" or die
	"Could not open appoint/151/151.106.s12.xxx for output\n";
