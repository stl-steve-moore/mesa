...
#`perl ClearSyslogTables.pl syslog`;
 ...
 mesa::delete_directory(1, "$MESA_STORAGE/wkstation/ppwf");
 mesa::create_directory(1, "$MESA_STORAGE/wkstation/ppwf");

 mesa::delete_directory(1, "$MESA_STORAGE/wkstation/instances");
 mesa::create_directory(1, "$MESA_STORAGE/wkstation/instances");

 mesa::delete_directory(1, "$MESA_STORAGE/wkstation/hl7");
 mesa::create_directory(1, "$MESA_STORAGE/wkstation/hl7");
