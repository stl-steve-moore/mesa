...
sub produce_211_data {
  ...
  $x = mod::send_hl7("../../msgs/adt/2xx", "211.102.a04.hl7", "localhost", "$mesa_hl7_port");
  mod::xmit_error("211.102.a04.hl7") if ($x != 0);

  $x = mod::send_hl7("../../msgs/order/2xx", "211.104.o01.hl7", "localhost", "$mesa_hl7_port");
  ...
  $x = "perl scripts/produce_scheduled_images.pl $mod $modAE " .
	" MM211 P1 T211 MESA localhost 2250 X1_A1 X1 MR/MR4/MR4S1 $protocolCodeFlag";
  print "$x \n";
...
announce_211;
produce_211_data($modality, $modalityAE, $modalityStationName, $includePerformedProtocolCode);
