...
sub self_test_211 {
  mesa::store_images("T211", "", "MESA_MODALITY",
		"MESA_IMG_MGR", "localhost", "2350", 1);

  mod::send_mpps("T211", "MESA_MODALITY", "MESA_IMG_MGR", "localhost", "2350");

  mod::send_storage_commit("T211", "MESA", "localhost", "2350", "2400");
}
...
sub self_test_215 {
  mesa::store_images("T215", "", "MESA_MODALITY",
		    "MESA_IMG_MGR", "localhost", "2350", 1);
  mod::send_mpps("T215", "MESA_MODALITY", "MESA_IMG_MGR", "localhost","2350");
}
...
if (scalar(@ARGV) == 0) {
 ...
 self_test_211 if ($ARGV[0] eq "211");
 self_test_213 if ($ARGV[0] eq "213");
 self_test_214 if ($ARGV[0] eq "214");
 self_test_215 if ($ARGV[0] eq "215");
