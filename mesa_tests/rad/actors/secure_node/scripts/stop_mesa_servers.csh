...
$MESA_TARGET/bin/tls_connect -s -c NULL-SHA $C/randoms.dat \
        $C/test_sys_1.key.pem $C/test_sys_1.cert.pem $C/mesa_list.cert \
        localhost 4100


$MESA_TARGET/bin/tls_connect -s -c NULL-SHA $C/randoms.dat \
        $C/test_sys_1.key.pem $C/test_sys_1.cert.pem $C/unregistered.cert \
        localhost 4101

$MESA_TARGET/bin/tls_connect -i EXPIRED -s -c NULL-SHA $C/randoms.dat \
        $C/test_sys_1.key.pem $C/test_sys_1.cert.pem $C/expired.cert \
        localhost 4102
