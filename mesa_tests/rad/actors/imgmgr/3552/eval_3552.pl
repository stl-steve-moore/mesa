...
sub x_3552_1 {
 print LOG "CTX: Image Manager 3552.1 \n";
 print LOG "CTX:  Evaluating CFind Response to query by SOP Class UID\n";
 print LOG "CTX:  Looking for specific Instance Level values\n";
 ...
 $rtnValue = mesa_evaluate::evalCFindBSPSInstanceLevel(
	$logLevel, $mesaFile, $testFile);

# ($x, $presentationLabel) = mesa_get::getDICOMValue($logLevel, $testFile,
#	"", "0008 0018", 1);
...
open LOG, ">3552/grade_3552.txt" or die "?!";
$diff = 0;
...
print "Logs stored in 3552/grade_3552.txt \n";
