...
print `$MESA_TARGET/bin/kill_hl7_secure -C $C -K $K -P $P -R $R -e RST "localhost" $mesaImgMgrPortHL7`;
...
mesa::rm_files("$MESA_TARGET/logs/send_hl7.log");
mesa::rm_files("hl7stream.xxx");
