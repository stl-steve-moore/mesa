...
# Order Filler
$MESA_TARGET/bin/hl7_rcvr -M OF -l $LOGLEVEL -a -z ordfil $MESA_OF_HL7_PORT &

# Image Manager
$MESA_TARGET/bin/hl7_rcvr -M IM -l $LOGLEVEL -a -z imgmgr $MESA_IMGMGR_HL7_PORT &

$MESA_TARGET/bin/of_dcmps -l $LOGLEVEL $MESA_OF_DICOM_PORT &

$MESA_TARGET/bin/ds_dcm -l $LOGLEVEL -r $MESA_IMGMGR_DICOM_PT $MESA_TARGET/runtime/imgmgr/ds_dcm.cfg &
