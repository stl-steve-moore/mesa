...
# MR Knee exam
rpt_crt::send_images("MR/MR3/MR3S1", "60x-j/mr3_1.del", "MESA_IMG_MGR",
			"localhost", "2350");

rpt_crt::send_images("MR/MR3/MR3S2", "60x-j/mr3_2.del", "MESA_IMG_MGR",
			"localhost", "2350");
...
# CR Chest PA
rpt_crt::send_images("CR/CR3/CR3S1", "60x-j/cr3_1.del", "MESA_IMG_MGR",
			"localhost", "2350");
...
# Multimodality study
# CR Tibia: AP
rpt_crt::send_images("CR/CR2/CR2S1", "60x-j/mm1_1.del", "MESA_IMG_MGR",
			"localhost", "2350");

# MR Knee
rpt_crt::send_images("MR/MR9/MR9S1", "60x-j/mm1_2.del", "MESA_IMG_MGR",
			"localhost", "2350");
