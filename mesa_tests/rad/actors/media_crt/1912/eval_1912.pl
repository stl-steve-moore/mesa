...
# Runs the Media Creator test 1912
...
$logLevel = $ARGV[0];
$mountPoint = $ARGV[1];
open LOG, ">1912/grade_1912.txt" or die "?!";
$diff = 0;

$diff = x_1912_x($logLevel, $mountPoint, 1);
if ($diff != 0) {
...
foreach $t(@testNumbers) {
 $diff += x_1912_x($logLevel, $mountPoint, $t);
}

print LOG "\nTotal Differences: $diff \n";
print "\nTotal Differences: $diff \n";

print "Logs stored in 1912/grade_1912.txt \n";
