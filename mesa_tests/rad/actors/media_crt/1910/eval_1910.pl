...
# Runs the Media Creator test 1910
...
$logLevel = $ARGV[0];
$mountPoint = $ARGV[1];
open LOG, ">1910/grade_1910.txt" or die "?!";
$diff = 0;

$diff = x_1910_x($logLevel, $mountPoint, 1);
if ($diff != 0) {
...
@testNumbers = (10, 11, 12);
foreach $t(@testNumbers) {
 $diff += x_1910_x($logLevel, $mountPoint, $t);
}

print LOG "\nTotal Differences: $diff \n";
print "\nTotal Differences: $diff \n";

print "Logs stored in 1910/grade_1910.txt \n";
