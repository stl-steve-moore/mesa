...
# Runs the Media Creator test 1911
...
$logLevel = $ARGV[0];
$mountPoint = $ARGV[1];
open LOG, ">1911/grade_1911.txt" or die "?!";
$diff = 0;

$diff = x_1911_x($logLevel, $mountPoint, 1);
if ($diff != 0) {
...
foreach $t(@testNumbers) {
 $diff += x_1911_x($logLevel, $mountPoint, $t);
}

print LOG "\nTotal Differences: $diff \n";
print "\nTotal Differences: $diff \n";

print "Logs stored in 1911/grade_1911.txt \n";
