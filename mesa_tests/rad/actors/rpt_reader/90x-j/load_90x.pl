...
rpt_reader::cstore("../../msgs/sr/601-j/sr_601cr.dcm", "",  "MESA_RPT_REPOS",
	"localhost", "2800");

rpt_reader::cstore("../../msgs/sr/602-j/sr_602ct.dcm", "",  "MESA_RPT_REPOS",
	"localhost", "2800");

rpt_reader::cstore("../../msgs/sr/603-j/sr_603mr.dcm", "",  "MESA_RPT_REPOS",
	"localhost", "2800");

rpt_reader::cstore("../../msgs/sr/611-j/sr_611.dcm", "",  "MESA_RPT_REPOS",
	"localhost", "2800");

# CR Chest PA
rpt_reader::send_images("CR/CR3/CR3S1", "../rpt_crt/60x-j/cr3_1.del",
		"MESA_IMG_MGR", "localhost", "2350");

# MR Knee exam
rpt_reader::send_images("MR/MR3/MR3S1", "../rpt_crt/60x-j/mr3_1.del",
		"MESA_IMG_MGR", "localhost", "2350");

rpt_reader::send_images("MR/MR3/MR3S2", "../rpt_crt/60x-j/mr3_2.del",
		"MESA_IMG_MGR", "localhost", "2350");

# CT Sprial Angio Thorax
rpt_reader::send_images("CT/CT5/CT5S1", "../rpt_crt/60x-j/ct5_1.del",
		"MESA_IMG_MGR", "localhost", "2350");
