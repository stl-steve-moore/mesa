...
mesa::cstore_secure("../../msgs/sr/601/sr_601cr.dcm", "",  "MESA", "MESA_RPT_REPOS",
	"localhost", "2800",
	"randoms.dat", "test_sys_1.key.pem", "test_sys_1.cert.pem", "mesa_list.cert", "NULL-SHA");

mesa::cstore_secure("../../msgs/sr/602/sr_602ct.dcm", "",  "MESA", "MESA_RPT_REPOS",
	"localhost", "2800",
	"randoms.dat", "test_sys_1.key.pem", "test_sys_1.cert.pem", "mesa_list.cert", "NULL-SHA");

mesa::cstore_secure("../../msgs/sr/603/sr_603mr.dcm", "",  "MESA", "MESA_RPT_REPOS",
	"localhost", "2800",
	"randoms.dat", "test_sys_1.key.pem", "test_sys_1.cert.pem", "mesa_list.cert", "NULL-SHA");

mesa::cstore_secure("../../msgs/sr/611/sr_611.dcm", "",  "MESA", "MESA_RPT_REPOS",
	"localhost", "2800",
	"randoms.dat", "test_sys_1.key.pem", "test_sys_1.cert.pem", "mesa_list.cert", "NULL-SHA");
