...
# Sends C-Find requests to Report Repository for 804 tests.
...
sub announce_test {
  print "\n" .
"This is MESA Report Repository test 804.  It sends C-Find requests for the " .
...
sub produce_queries {
  ...
  open F, ">804/q804a.txt" or die "Could not open output file for query\n";
  ...
  rpt_repos::make_dcm_object("804/q804a");
}

sub send_q804a {
  $outDir = "804/q804a";
  $outDirMESA = "804/q804a_mesa";
  ...
  rpt_repos::send_cfind("804/q804a.dcm", $rptAE, $rptHost, $rptPort, $outDir);
  rpt_repos::send_cfind("804/q804a.dcm", "MESA_RPT_REPOS", "localhost", "2800", $outDirMESA);
}
