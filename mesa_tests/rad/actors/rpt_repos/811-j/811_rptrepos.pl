...
# Sends C-Move request to Report Repository for 811-j tests.
...
sub announce_test {
  print "\n" .
"This is MESA Report Repository test 811-j.  It sends a C-Move request \n"; 
}

sub send_q811a {
  rpt_repos::send_cmove_study_uid("811-j/q811a", $rptAE, $rptHost,
