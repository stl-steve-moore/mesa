...
# Runs the Year 4:1502 Order Filler exam interactively.
# This is test 102 with basic security options.
...
sub announce_test {
  print
"\n" .
"This is Order Filler Test 1502 for subject Brown.\n\n";
}
...
sub send_CFIND_P1 {
  ...
  $x = "$MESA_TARGET/bin/mwlquery_secure -a MODALITY1 -c $mwlAE -f mwl/mwlquery_brown.dcm " .
       "-o $resultsDir $mwlHost $mwlPort";
  print "$x\n";
  print `$x`;

  $x = "$MESA_TARGET/bin/mwlquery_secure -a MODALITY1 -f mwl/mwlquery_brown.dcm " .
...
# Setup commands
#$ncreate = "$MESA_TARGET/bin/ncreate ";
#$nset = "$MESA_TARGET/bin/nset ";
...
$x = mesa::send_hl7_secure("../../msgs/adt/102", "102.102.a05.hl7", $ofHostHL7, $ofPortHL7,
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.102.a05.hl7") if ($x != 0);
$x = mesa::send_hl7_secure("../../msgs/adt/102", "102.102.a05.hl7", "localhost", "2200",
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.102.a05.hl7") if ($x != 0);

ordfil::announce_order_orm("P1");

$x = mesa::send_hl7_secure("../../msgs/order/102", "102.104.o01.hl7", $ofHostHL7, $ofPortHL7,
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.104.o01.hl7") if ($x != 0);
$x = mesa::send_hl7_secure("../../msgs/order/102", "102.104.o01.hl7", "localhost", "2200",
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.104.o01.hl7") if ($x != 0);
...
$x = mesa::send_hl7_secure("../../msgs/adt/102", "102.108.a01.hl7", $ofHostHL7, $ofPortHL7,
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.108.a01.hl7") if ($x != 0);
$x = mesa::send_hl7_secure("../../msgs/adt/102", "102.108.a01.hl7", "localhost", "2200",
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.108.a01.hl7") if ($x != 0);
...
$x = mesa::send_hl7_secure("../../msgs/order/102", "102.122.o01.hl7", $ofHostHL7, $ofPortHL7,
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.122.o01.hl7") if ($x != 0);
$x = mesa::send_hl7_secure("../../msgs/order/102", "102.122.o01.hl7", "localhost", "2200",
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.122.o01.hl7") if ($x != 0);
...
$x = mesa::send_hl7_secure("../../msgs/order/102", "102.131.o01.hl7", "localhost", "2200",
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.131.o01.hl7") if ($x != 0);

$x = mesa::send_hl7_secure("../../msgs/order/102", "102.132.o02.hl7", $ofHostHL7, $ofPortHL7,
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error("102.132.o02.hl7") if ($x != 0);
...
$x = mesa::send_hl7_secure("../../msgs/adt/102", "102.136.a03.hl7", $ofHostHL7, $ofPortHL7,
	"randoms.dat", "mesa_1.key.pem", "mesa_1.cert.pem", "test_list.cert", "NULL-SHA");
mesa::xmit_error_secure("102.136.a03.hl7") if ($x != 0);
request_a03;
