...
# Runs the Order Filler exam interactively.
...
print "\n" .
  "This is MESA Order Filler test 1422.  It tests post-processing\n" .
...
# $mesa_spsSOPUID = ordfil::getSOPUID("1422/gpsps_x102_mesa/msg1_result.dcm");
# chomp $mesa_spsSOPUID;
# print "mesa_spsSOPUID: " . $mesa_spsSOPUID . "\n";

$test_spsSOPUID = ordfil::getSOPUID("1422/gpsps_x102/msg1_result.dcm");
...
print "\n" .
  "The Order Filler test 1422 is complete.  To evaluate \n" .
  "your responses:  \n" .
