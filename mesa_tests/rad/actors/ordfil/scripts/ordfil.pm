...
# Package for Order Filler scripts.
...
sub test_var_names {
  ...
  my $rtnVal = 0;
  my @names = (
	"MESA_ORD_PLC_PORT_HL7", "MESA_IMG_MGR_PORT_HL7", "MESA_IMG_MGR_PORT_DCM",
	"MESA_CHG_PRC_PORT_HL7",
	"TEST_HL7_HOST", "TEST_HL7_PORT",
	"TEST_MWL_AE",  "TEST_MWL_HOST",  "TEST_MWL_PORT",
...
sub evaluate_mpps {
  print main::LOG "ordfil::evaluate_mpps is retired.  Error in the test script\n";
  print "ordfil::evaluate_mpps is retired.  Error in the test script\n";
  exit 1;
