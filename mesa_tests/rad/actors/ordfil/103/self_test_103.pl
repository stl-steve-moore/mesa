...
# Self test for Order Filler test 103.
...
$x = ordfil::send_hl7("../../msgs/sched/103", "103.106.o01.hl7", "localhost", $imPortHL7);
ordfil::xmit_error("103.106.o01.hl7") if ($x != 0);

$x = ordfil::send_hl7("../../msgs/adt/103", "103.132.a08.hl7", "localhost", $imPortHL7);
