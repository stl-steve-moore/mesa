...
# Generate HL7 messages for Case 20501
  ...
  mesa_msgs::create_text_file_2_var_files(
	"20810.102.r01.txt",		# This is the output
	"../templates/r01.tpl",		# Template for an R01 message
	"doej1.txt",			# Demographics, PV1 information
	"20810.102.r01.var");		# Input with ADT information
  
  
  mesa_msgs::create_hl7("20810.102.r01");
  
  #my $pwd = `pwd`;
  my $pwd = getcwd();
  chomp $pwd;

  mesa_msgs::addAttachment("20810.102.r01.hl7", 		#file to be modified 
			   "obx_xml_to_be_attached",		#place holder
			   $pwd,				#directory where the attachment file is
			   "20810.102.r01.xml"  		#file to be attached
			   );
  1;
