...
sub x_20102_2x {
  print LOG "CTX: Order Filler 20102.2 \n";
  print LOG "CTX: Evaluating MWL response for procedure CATH.001/XX-20011 \n";

  $p1MWLFile =     ordfil::mwl_find_matching_procedure_code("20102/mwl_q1/test", "CATH.001");
  $p1MWLFileMESA = ordfil::mwl_find_matching_procedure_code("20102/mwl_q1/mesa", "CATH.001");

  if ($p1MWLFile eq "") {
    print LOG "ERR: Unable to locate MWL results for requested procedure CATH.001\n";
    print LOG "ERR:  You should examine the MWL results in 20102/mwl_q1 \n";
    $diff += 1;
    ...
    print LOG "ERR:  You should examine the MWL results in 20102/mwl_q1/mesa \n";
    $diff += 1;
  } else {
    $diff += mesa::evaluate_one_mwl_resp(
 		$logLevel,
 		"20102/mwl_q1/test/$p1MWLFile",
 		"20102/mwl_q1/mesa/$p1MWLFileMESA");
  }
...
sub x_20102_2 {
  ...
  @p1MWLFilesTEST =  ordfil::mwl_search_by_procedure_code_only($logLevel, "20102/mwl_q1/test", "CATH.001");
  @p1MWLFilesMESA = ordfil::mwl_search_by_procedure_code_only($logLevel, "20102/mwl_q1/mesa", "CATH.001");
...
sub x_20102_4 {
  print LOG "CTX: Order Filler 20102.4 \n";
  print LOG "CTX: Evaluating MWL response for SPS for IVUS - triggered by HD MPPS\n";

  @p1MWLFilesTEST =  ordfil::mwl_search_by_procedure_code_aetitle($logLevel, "20102/mwl_q2/test", "CATH.001", "LAB7_IVUS");
  @p1MWLFilesMESA = ordfil::mwl_search_by_procedure_code_aetitle($logLevel, "20102/mwl_q2/mesa", "CATH.001", "LAB7_IVUS");
...
$logLevel     = $ARGV[0];
#$titleMPPSMgr = $ARGV[1];
open LOG, ">20102/grade_20102.txt" or die "?!";
$diff = 0;
...
print "Logs stored in 20102/grade_20102.txt \n";
