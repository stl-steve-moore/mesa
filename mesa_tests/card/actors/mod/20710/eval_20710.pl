...
sub x_20710_1 {
   print LOG "CTX: Cardiology Stress Workflow Test 20710.1 \n";
   ...
   my $refObject = "$MESA_STORAGE/modality/T20710/x1.dcm";
   my $testObject = $x[0];
...
$logLevel = $ARGV[0];
open LOG, ">20710/grade_20710.txt" or die "?!";
$diff = 0;
$patientID = "20710";
...
print "Logs stored in 20710/grade_20710.txt \n";
