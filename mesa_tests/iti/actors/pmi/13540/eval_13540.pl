...
sub x_13540_1 {
  print LOG "\nCTX: PMI 13540.1\n";
  print LOG "CTX: Evaluation using ATNA Log Message-Import Schematron\n";

  my ($logLevel, $file) = @_;
  print LOG "CTX: File $file\n";

#  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 13540/13540_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 13540/13540.xsl -PARAM diagnose yes";
  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 13540/13540_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 13540/13540.xsl -PARAM diagnose yes";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;

  $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN $file -XSL 13540/13540.xsl -OUT 13540/schematron_13540.log";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;
...
sub appendResult {
  open RESULT, "13540/schematron_13540.log" or die "Could not open output file 13540/schematron_13540.log";
...
# Main starts here
 ...
 die "Usage: perl 13540/eval_13540.pl <log level> " if (scalar(@ARGV) < 1);
 $logLevel = $ARGV[0];

 open LOG, ">13540/grade_13540.txt" or die "Could not open output file 13540/grade_13540.txt";
 ...
 my $diff = 0;
 $diff += x_13540_1($logLevel, $fileName);
 ...
 print "Logs stored in 13540/grade_13540.txt\n";
 exit 0;
