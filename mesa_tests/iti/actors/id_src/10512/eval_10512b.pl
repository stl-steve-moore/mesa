...
# sent by an Identity Source system for test 10512b.
...
sub x_10512_1 {
  ...
  $diff += mesa::evaluate_ADT_A04_PIX (
	$logLevel,
	"../../msgs/adt/10512/10512.104.a04.hl7",
...
open LOG, ">10512/grade_10512b.txt" or die "Could not open output file 10512/grade_10512.txt";
...
print "\nTotal Differences: $diff \n";
print "Logs stored in 10512/grade_10512b.txt \n";
