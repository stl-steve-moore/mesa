...
#  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11189/11189_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11189/11189.xsl -PARAM diagnose yes";
  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11189/11189_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11189/11189.xsl -PARAM diagnose yes";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;

  $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN $file -XSL 11189/11189.xsl -OUT 11189/schematron_11189.log";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;
...
sub appendResult {
  open RESULT, "11189/schematron_11189.log" or die "Could not open output file 11189/schematron_11189.log";
...
# Main starts here
 ...
 die "Usage: perl 11189/eval_11189.pl <log level> " if (scalar(@ARGV) < 1);
 $logLevel = $ARGV[0];

 open LOG, ">11189/grade_11189.txt" or die "Could not open output file 11189/grade_11189.txt";
 ...
 my $diff = 0;
 $diff += x_11189_1($logLevel, $fileName);
 ...
 print "Logs stored in 11189/grade_11189.txt\n";
 exit 0;
