...
sub x_11195_1 {
  print LOG "\nCTX: PMI 11195.1\n";
  print LOG "CTX: Evaluation using ATNA Log Message-Actor Patient Record Schematron\n";

  my ($logLevel, $file) = @_;
  print LOG "CTX: File $file\n";

#  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11195/11195_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11195/11195.xsl -PARAM diagnose yes";
  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11195/11195_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11195/11195.xsl -PARAM diagnose yes";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;

  $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN $file -XSL 11195/11195.xsl -OUT 11195/schematron_11195.log";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;
...
sub appendResult {
  open RESULT, "11195/schematron_11195.log" or die "Could not open output file 11195/schematron_11195.log";
...
# Main starts here
 ...
 die "Usage: perl 11195/eval_11195.pl <log level> " if (scalar(@ARGV) < 1);
 $logLevel = $ARGV[0];

 open LOG, ">11195/grade_11195.txt" or die "Could not open output file 11195/grade_11195.txt";
 ...
 my $diff = 0;
 $diff += x_11195_1($logLevel, $fileName);
 ...
 print "Logs stored in 11195/grade_11195.txt\n";
 exit 0;
