...
sub x_11198_1 {
  print LOG "\nCTX: PMI 11198.1\n";
  print LOG "CTX: Evaluation using ATNA Log Message-Actor Procedure Record Schematron\n";

  my ($logLevel, $file) = @_;
  print LOG "CTX: File $file\n";

#  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11198/11198_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11198/11198.xsl -PARAM diagnose yes";
  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11198/11198_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11198/11198.xsl -PARAM diagnose yes";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;

  $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN $file -XSL 11198/11198.xsl -OUT 11198/schematron_11198.log";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;
...
sub appendResult {
  open RESULT, "11198/schematron_11198.log" or die "Could not open output file 11198/schematron_11198.log";
...
# Main starts here
 ...
 die "Usage: perl 11198/eval_11198.pl <log level> " if (scalar(@ARGV) < 1);
 $logLevel = $ARGV[0];

 open LOG, ">11198/grade_11198.txt" or die "Could not open output file 11198/grade_11198.txt";
 ...
 my $diff = 0;
 $diff += x_11198_1($logLevel, $fileName);
 ...
 print "Logs stored in 11198/grade_11198.txt\n";
 exit 0;
