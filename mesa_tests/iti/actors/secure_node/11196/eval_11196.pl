...
sub x_11196_1 {
  print LOG "\nCTX: PMI 11196.1\n";
  print LOG "CTX: Evaluation using ATNA Log Message-Actor PHI Export Schematron\n";

  my ($logLevel, $file) = @_;
  print LOG "CTX: File $file\n";

#  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11196/11196_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11196/11196.xsl -PARAM diagnose yes";
  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11196/11196_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11196/11196.xsl -PARAM diagnose yes";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;

  $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN $file -XSL 11196/11196.xsl -OUT 11196/schematron_11196.log";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;
...
sub appendResult {
  open RESULT, "11196/schematron_11196.log" or die "Could not open output file 11196/schematron_11196.log";
...
# Main starts here
 ...
 die "Usage: perl 11196/eval_11196.pl <log level> " if (scalar(@ARGV) < 1);
 $logLevel = $ARGV[0];

 open LOG, ">11196/grade_11196.txt" or die "Could not open output file 11196/grade_11196.txt";
 ...
 my $diff = 0;
 $diff += x_11196_1($logLevel, $fileName);
 ...
 print "Logs stored in 11196/grade_11196.txt\n";
 exit 0;
