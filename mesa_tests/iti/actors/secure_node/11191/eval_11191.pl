...
#  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11191/11191_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11191/11191.xsl -PARAM diagnose yes";
  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11191/11191_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11191/11191.xsl -PARAM diagnose yes";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;

  $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN $file -XSL 11191/11191.xsl -OUT 11191/schematron_11191.log";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;
...
sub appendResult {
  open RESULT, "11191/schematron_11191.log" or die "Could not open output file 11191/schematron_11191.log";
...
# Main starts here
 ...
 die "Usage: perl 11191/eval_11191.pl <log level> " if (scalar(@ARGV) < 1);
 $logLevel = $ARGV[0];

 open LOG, ">11191/grade_11191.txt" or die "Could not open output file 11191/grade_11191.txt";
 ...
 my $diff = 0;
 $diff += x_11191_1($logLevel, $fileName);
 ...
 print "Logs stored in 11191/grade_11191.txt\n";
 exit 0;
