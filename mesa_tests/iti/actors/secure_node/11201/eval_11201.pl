...
sub x_11201_1 {
  print LOG "\nCTX: PMI 11201.1\n";
  print LOG "CTX: Evaluation using ATNA Log Message-Actor Study Object Schematron\n";

  my ($logLevel, $file) = @_;
  print LOG "CTX: File $file\n";

#  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11201/11201_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11201/11201.xsl -PARAM diagnose yes";
  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11201/11201_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11201/11201.xsl -PARAM diagnose yes";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;

  $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN $file -XSL 11201/11201.xsl -OUT 11201/schematron_11201.log";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;
...
sub appendResult {
  open RESULT, "11201/schematron_11201.log" or die "Could not open output file 11201/schematron_11201.log";
...
# Main starts here
 ...
 die "Usage: perl 11201/eval_11201.pl <log level> " if (scalar(@ARGV) < 1);
 $logLevel = $ARGV[0];

 open LOG, ">11201/grade_11201.txt" or die "Could not open output file 11201/grade_11201.txt";
 ...
 my $diff = 0;
 $diff += x_11201_1($logLevel, $fileName);
 ...
 print "Logs stored in 11201/grade_11201.txt\n";
 exit 0;
