...
if ($y == 0) {
 $x = "echo \"check command line parameters, should be one of (3164, 5425, 5426, TCP)\"";
  ...
  $x = "$MESA_TARGET/bin/syslog_client_secure -f 10 -s 5 -r 5424 -x 5425 -C $C -K $K -P $P -R $R -Z $Z localhost  4003 11115/atna_startup.xml";
  ...
  $x = "$MESA_TARGET/bin/syslog_client -f 10 -s 5 -r 5424 -x TCP -t PID localhost 4000 11115/atna_startup.xml";
}
