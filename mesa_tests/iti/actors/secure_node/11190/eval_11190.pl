...
#  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11190/11190_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11190/11190.xsl -PARAM diagnose yes";
  my $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN 11190/11190_schematron.xml -XSL schematron/schematron-basic.xsl -OUT 11190/11190.xsl -PARAM diagnose yes";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;

  $x = "java -cp $MESA_TARGET/lib/xalan.jar org.apache.xalan.xslt.Process -IN $file -XSL 11190/11190.xsl -OUT 11190/schematron_11190.log";
  print LOG "CTX: $x\n" if ($logLevel >= 3);
  print LOG `$x`;
...
sub appendResult {
  open RESULT, "11190/schematron_11190.log" or die "Could not open output file 11190/schematron_11190.log";
...
# Main starts here
 ...
 die "Usage: perl 11190/eval_11190.pl <log level> " if (scalar(@ARGV) < 1);
 $logLevel = $ARGV[0];

 open LOG, ">11190/grade_11190.txt" or die "Could not open output file 11190/grade_11190.txt";
 ...
 my $diff = 0;
 $diff += x_11190_1($logLevel, $fileName);
 ...
 print "Logs stored in 11190/grade_11190.txt\n";
 exit 0;
