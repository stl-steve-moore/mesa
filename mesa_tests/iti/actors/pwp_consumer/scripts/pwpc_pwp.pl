...
# Runs the PWP Consumer tests

use Env;
use lib "scripts";
require pwp_consumer;
...
%varnames = mesa::get_config_params("pwp_consumer.cfg");
#print_config_params();

$testDirectoryHost = $varnames{"MESA_DIRECTORY_HOST"};
$testBaseDN        = $varnames{"MESA_BASE_DN"};
