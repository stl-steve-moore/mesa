...
#  lincoln_domain2.txt
  ...
  mesa_msgs::create_text_file_2_var_files (
	"10514.102.a04.txt",	# The output file
	"../templates/a04_iti8.tpl",	# Template for an A04: ITI-8
	"washington_domain1.txt",	# PID, PV1 data
	"10514.102.a04.var"	# A04 variables not in PID, PV1
  );
  mesa_msgs::create_hl7("10514.102.a04");

  mesa_msgs::create_text_file_2_var_files (
	"10514.104.a04.txt",	# The output file
	"../templates/a04_iti8.tpl",	# Template for an A04: ITI-8
	"lincoln_domain1.txt",	# PID, PV1 data
	"10514.104.a04.var"	# A04 variables not in PID, PV1
  );
  mesa_msgs::create_hl7("10514.104.a04");

  mesa_msgs::create_text_file_2_var_files (
	"10514.106.a04.txt",	# The output file
	"../templates/a04_iti8.tpl",	# Template for an A04: ITI-8
	"washington_domain2.txt",	# PID, PV1 data
	"10514.106.a04.var"	# A04 variables not in PID, PV1
  );
  mesa_msgs::create_hl7("10514.106.a04");

  mesa_msgs::create_text_file_2_var_files (
	"10514.108.a40.txt",	# The output file
	"../templates/a40_iti8.tpl",	# Template for an A40: ITI-8
	"merge_domain1.txt",	# PID, PV1 data
	"10514.108.a40.var"	# A40 variables not in PID, PV1
  );
  mesa_msgs::create_hl7("10514.108.a40");
