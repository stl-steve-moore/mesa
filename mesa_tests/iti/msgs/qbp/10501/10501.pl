...
# Generate HL7 messages for Case 10501
...
#  simpson_domain1.txt
  ...
  mesa_msgs::create_text_file_2_var_files (
	"10501.108.q23.txt",	# The output file
	"../templates/q23.tpl",	# Template for a Q23
	"null.txt",	# 
	"10501.108.q23.var"	# 
  );
  mesa_msgs::create_hl7("10501.108.q23");

  mesa_msgs::create_text_file_2_var_files (
	"10501.110.q23.txt",	# The output file
	"../templates/q23.tpl",	# Template for a Q23
	"null.txt",	# 
	"10501.110.q23.var"	# 
  );
  mesa_msgs::create_hl7("10501.110.q23");
